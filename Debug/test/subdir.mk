...
test/%.o: ../test/%.cpp test/subdir.mk
	...
	g++ -I"/Users/shubham/Documents/eclipse/MotionPlanning/include" -O0 -g3 -Wall -c -fmessage-length=0 -std=c++14 -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
...
clean-test:
	-$(RM) ./test/ForwardKinematics_test.d ./test/ForwardKinematics_test.o ./test/IK6AxisInline_test.d ./test/IK6AxisInline_test.o ./test/IK6AxisOffset_test.d ./test/IK6AxisOffset_test.o ./test/Jacobian_test.d ./test/Jacobian_test.o ./test/RecursiveNewtonEuler_test.d ./test/RecursiveNewtonEuler_test.o
