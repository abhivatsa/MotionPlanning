...
int IK6AxisOffset::computeIK(Eigen::Vector3d eef_pos, Eigen::Matrix3d eef_orient,
    ...
    for (size_t ctr = 0; ctr < sol_init.size(); ctr++){
		...
		sol_final[2*ctr+1] = {th1, th2_5, th3_1, th4_5, th5, th6};
		sol_final[2*ctr+2] = {th1, th2_2, th3_2, th4_2, th5, th6};
		sol_final[2*ctr+3] = {th1, th2_6, th3_2, th4_6, th5, th6};
		sol_final[2*ctr+4] = {th1, th2_3, th3_3, th4_3, th5, th6};
		sol_final[2*ctr+5] = {th1, th2_7, th3_3, th4_7, th5, th6};
		sol_final[2*ctr+6] = {th1, th2_4, th3_4, th4_4, th5, th6};
		sol_final[2*ctr+7] = {th1, th2_8, th3_4, th4_8, th5, th6};
